    ...
    <Container class="max-w-lg mx-auto p-4">
      <Section class="bg-white rounded-lg shadow p-6">
        ...
        <Text class="mb-4 text-gray-700">
          This is a security alert. Your account password was recently changed.
        </Text>
        ...
        <Text class="mb-4 text-gray-700">
          If you did not change your password, we recommend you secure your account immediately by resetting your password.
        </Text>
