import type { ZodAutoFormConfig, ComponentsMap } from '~/types/zodform'
...
export const ZodFormComponents: ComponentsMap = {
...
export function mapZodTypeToComponent(key: string, zodType: any, config: ZodAutoFormConfig, state: any): ComponentDefinition | null {
